...
import { useEditBidderInformationsMutation } from "../../Slices/bidderApiSlice";
...
const EditInfo = () => {
  ...
  const handleImageUpload = (e) => {
    if (!profilePicture) {
      console.log("testworking1");
      e.preventDefault();

      handleFormSubmit();
    } else if (profilePicture?.name == updatedImg?.name) {
      console.log("testworking2");
      e.preventDefault();
      handleFormSubmit();
    } else if (form.ProfilePicture == bidder.ProfilePicture) {
      console.log("testworking3");
      console.log(form.ProfilePicture, bidder.ProfilePicture);
      e.preventDefault();
      handleFormSubmit();
    } else {
      e.preventDefault();
